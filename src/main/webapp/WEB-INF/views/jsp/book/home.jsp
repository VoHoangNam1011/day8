	                    ...
	                    <tbody>
	                        <c:forEach var="book" items="${bookList}" varStatus="index">
	                            <tr>
	                                ...
	                                <td>
	                                    <button class="btn-sm btn-primary" onclick="location.href='edit/${book.id}'">Edit</button>
	                                    <button class="btn-sm btn-danger" onclick="location.href='delete/${book.id}'">Delete</button>
	                                </td>
	                            </tr>
	                        </c:forEach>
	                    </tbody>
